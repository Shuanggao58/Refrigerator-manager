...
try:
    while True:
        try:
            time.sleep(0.1)
            module = Module()
            flag = os.path.isfile(r'C:\Users\78109\Documents\Visual Studio 2015\Projects\opencvtest\opencvtest\capture.jpg')
            if flag == 1:
                
                string = module.classification(r'C:\Users\78109\Documents\Visual Studio 2015\Projects\opencvtest\opencvtest\capture.jpg')
                os.remove(r'C:\Users\78109\Documents\Visual Studio 2015\Projects\opencvtest\opencvtest\capture.jpg')
                print(string)

                with open(r'C:\Users\78109\Documents\Visual Studio 2015\Projects\opencvtest\opencvtest\result.txt',"w") as f:
                        f.write(string)
